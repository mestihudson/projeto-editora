...
public class Validator<T> {
	...
	public boolean validarObservacao(String obs) {
		if (obs.isEmpty()) {
			resultObservacao = "Informe a observação";
			return false;
		} else {
			if (obs.contains("'") || obs.contains("*")) {
				resultObservacao = "Cont�m caract�re(s) inv�lido(s)";
				return false;
			} else {
				resultObservacao = "";
				return true;
	...
	public boolean validarCodigoRegistro(String field, Integer codigo) {
		if (codigo == null || codigo == 0) {
			resultCodigoRegistro = "O registro n�o pode ser nulo";
			codigo = null;
			return false;
		} else {
			dao = new GenericDAOImp<T, Integer>(persClass);
			...
			if (!q.getResultList().isEmpty()) {
				resultCodigoRegistro = "C�digo j� registrado";
				return false;
			} else {
	...
	public boolean validarCnpj(String field, String cnpj) {
		if (cnpj.contains(".") || cnpj.contains("/") || cnpj.contains("-")) {
			resultCnpj = "Informe somente n�meros";
			return false;
		} else {
			if (cnpj.length() < 14) {
	...
	public boolean validarCpf(String field, String cpf) {
		if (cpf.contains(".") || cpf.contains("/") || cpf.contains("-")) {
			resultCpf = "Informe somente n�meros";
			return false;
		} else {
			if (cpf.length() < 11) {
	...
	public boolean validarLaboratorio(Object obj) {
		if (obj == null) {
			resultLaboratorio = "Selecione um laborat�rio";
			return false;
		} else {
			resultLaboratorio = "";
			return true;
	...
	public boolean validarQuantidadeCritica(Integer qtd) {
		try {
			if (qtd == 0 || qtd == null) {
				resultQuantidadeCritica = "Informe a quantidade cr�tica";
				return false;
			} else if (qtd < 0) {
				resultQuantidadeCritica = "A quantidade cr�tica deve ser um n�mero maior que zero";
				return false;
			} else {
			...
			resultQuantidadeCritica = "Informe somente n�meros";
			return false;
		}
	}
	...
	public boolean validarNomeMae(String nm) {
		if (nm.isEmpty()) {
			resultNomeMae = "Informe o nome da m�e";
			return false;
		} else if (nm.contains("'")) {
			resultNomeMae = "Caract�re inv�lido";
			return false;
		} else {
			resultNomeMae = "";
			return true;
	...
	public boolean validarProfissao(String p) {
		if (p.isEmpty()) {
			resultProfissao = "Informe a profiss�o, mesmo se aposentado";
			return false;
		} else if (!p.contains("'")) {
			resultProfissao = "";
			return true;
		} else {
			resultProfissao = "Caract�re inv�lido";
			return false;
		}
	}
	...
	public boolean validarLogradouro(String l) {
		if (l.isEmpty()) {
			...
			resultLogradouro = "Caract�re inv�lido";
			return false;
		} else {
			resultLogradouro = "";
			return true;
	...
	public boolean validarNumero(Integer o) {
		try {
			if (o == 0 || o == null) {
				resultNumero = "Informe o n�mero";
				return false;
			} else if (o.toString().contains("'")) {
				resultNumero = "Caract�re inv�lido";
				return false;
			} else {
				resultNumero = "";
				return true;
			...
			resultNumero = "Informe somente n�meros";
			return false;
		}
	}
	...
	public boolean validarBairro(String o) {
		if (o.isEmpty()) {
			...
			resultBairro = "Caract�re inv�lido";
			return false;
		} else {
			resultBairro = "";
			return true;
	...
	public boolean validarComplemento(String o) {
		if (o.contains("'")) {
			resultComplemento = "Caract�re inv�lido";
			return false;
		} else {
			resultComplemento = "";
			return true;
	...
	public boolean validarCidade(String o) {
		if (o.isEmpty()) {
			...
			resultCidade = "Caract�re inv�lido";
			return false;
		} else {
			resultCidade = "";
			return true;
	...
	public boolean validarDddResidencial(Integer i) {
		try {
			if (i == null || i == 0) {
				...
				resultTelefoneResidencial = "DDD inv�lido";
				return false;
			} else {
				return true;
			}
		} catch (NumberFormatException e) {
			resultTelefoneResidencial = "Informe somente n�meros";
			return false;
		}
	...
	public boolean validarDddCelular(Integer i) {
		try {
			if (i == null || i == 0) {
				...
				resultTelefoneCelular = "DDD inv�lido";
				return false;
			} else {
				return true;
			}
		} catch (NumberFormatException e) {
			resultDddCelular = "Informe somente n�meros";
			return false;
		}
	}
	...
	public boolean validarDddRecado(Integer i) {
		try {
			if (i == null || i == 0) {
				...
				resultTelefoneRecado = "DDD inv�lido";
				return false;
			} else {
				return true;
			}
		} catch (NumberFormatException e) {
			resultDddRecado = "Informe somente n�meros";
			return false;
		}
	}
	...
	public boolean validarTelefoneCelular(String o) {
		if (o.isEmpty() || o.length() < 8) {
			...
			resultTelefoneCelular = "Informe somente n�meros";
			return false;
		} else {
	...
	public boolean validarTelefoneRecado(String o) {
		if (o.isEmpty() || o.length() < 8) {
			...
			resultTelefoneRecado = "Informe somente n�meros";
			return false;
		} else {
	...
	public boolean validarNomeRecado(String p) {
		if (p.isEmpty()) {
			...
			resultNomeRecado = "Caract�re inv�lido";
			return false;
		} else {
			resultNomeRecado = "";
			return true;
	...
	public boolean validarProtocoloCecor(Integer prot) {
		if (prot == null || prot == 0) {
			resultProtocoloCecor = "Informe o n�mero de protocolo";
			return false;
		} else {
			dao = new GenericDAOImp<T, Integer>(persClass);
			Query q = dao
			...
			if (!q.getResultList().isEmpty()) {
				resultProtocoloCecor = "Protocolo j� registrado";
				return false;
			} else {
	...
	public boolean validarDtFim(Date inicio, Date fim) {
		if (fim == null) {
			resultDtTermino = "Informe a data do t�rmino";
			return false;
		} else if(inicio == null) {
			resultDtTermino = "Informe tamb�m a data de inicio";
			return false;
		} else if(fim.before(inicio)) {
			resultDtTermino = "A data de t�rmino deve ser posterior � de inicio";
			return false;
		} else {
			resultDtTermino = "";
			return true;
	...
	public boolean validarExistenciaTratamento(Integer hcm, Integer cecor) {
		try {
			...
			if(q.getResultList().isEmpty()) {
				...
				resultExistenciaTratamento = "HCM j� existente para o protocolo do paciente";
				return false;
			}
		}catch(Exception e) {
			e.printStackTrace();
